      ...
      <section className=" bg-backgorund mt-6">
        ...
        <div className=" w-4/4 mx-12 my-6 h-full border border-collapse border-black">
          ...
          <div className=" mb-12 mx-8">
              ...
              >
                <Link to="/bankslip">
                  ...
                  <div className="mx-14 my-4">
                    <p className="">Account No (Afghani): xxxxxxxxxx</p>{" "}
                    <p className="">Account No (Dollar): xxxxxxxxxx</p>
                  </div>
                </Link>
              </div>
            ...
            <div>
              <h1 className="my-8 text-xl font-semibold">Credit payment</h1>
              <div className="">
                <div
                ...
                <div className="flex justify-center ">
                  <input
                    type="text"
                    className="block pl-3 bg-backgorund  border border-black w-96  h-11 rounded mt-6"
                    name="Name of Card"
